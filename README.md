...
![reviw table](./img/reviews-table.png)
 ...
 ### Получает список и интерфейс файлов 

 В сводной таблице кликаем по ID или Имени клиента  - переходи на страницу содержащую список файлов.
 На странице получаем интерфейс к существующим файлам:
 - переименовать;
 - добавить и (или) изменить комментарий к файлу;
 - поделиться ссылкой;
 - удалить один файл;
 - удалить все файлы.
